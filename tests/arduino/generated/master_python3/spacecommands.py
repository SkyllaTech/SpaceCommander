...
class MasterBase:
    ...
    def test_hash(self, address):
        ...
        if hash_val != 0xdfdf2feba025bd44:
            print('Hash Mismatch! Received hash {} but expected {}. Ensure both host and device are the same version.'.format(hex(hash_val), b'dfdf2feba025bd44'.upper()))
            return False
        return True
